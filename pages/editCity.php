...
$get_city = $city->getSingleCity($id);
...
if(isset($_POST['updateCity'])){
    ...
    $city->updateCity($id,$cityname,$countries);
}
                            ...
                            <div class="card-body">
                                <form method="post" action="">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="cityname" class="form-control" value="<?php echo $get_city['city_id'];?>">
                                    </div>

                                    <div class="form-group">
                                      <select type="text" name="countries" class="form-control" value="<?php echo $get_city['countries_id'];?>">
                                        <?php
                                        ...
                                        foreach($result as $key => $row){
                                            ...
                                            echo "<option value='$countries_id'>$countries_name</option>";
                                        }
                                        ?>
                                      </select>
                                    </div>
