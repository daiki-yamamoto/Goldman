...
$get_room = $room->getSingleRoom($room_id);
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-9 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
            <p class="breadcrumbs" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span class="mr-2"></span> <span class="mr-2"></span> <span>Hotel Single</span></p>
            <h1 class="mb-3 bread" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Room Details</h1>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="col-lg-9">
          	<div class="row">
          		<div class="col-md-12 ftco-animate">
          			<div class="single-slider owl-carousel">
          				<div class="item">
						  	...
						  	<img src='../uploads/<?php echo $image; ?>'class=''>
          		...
          		<div class="col-md-12 hotel-single mt-4 mb-5 ftco-animate">
          			...
          			<h2><?php echo $get_room['room_title']; ?></h2>

					<h2>Room Capacity</h2>

					<h2><?php echo $get_room['room_capacity']; ?> Person/s</h2>
