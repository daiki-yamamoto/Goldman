						...
						<?php
							...
							if($result === FALSE){
								...
								foreach($result as $key => $row){
									...
									echo"<td>
									<a href='editCity.php?city_id=$city_id' class='btn btn-info'>Edit</a>
									<a href='deleteCity.php?city_id=$city_id' class='btn btn-danger'>Delete</a>
			...
			<div class="row mb-5">
				<div class="col-md">
					<div class="ftco-footer-widget mb-4">
						...
						<p>Far far away, behind the word mountains, far from the city Vokalia and Consonantia,
