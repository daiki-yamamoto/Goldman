...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    <div class="container">
      <a class="navbar-brand" href="home.php">Under The Sky</a>
        ...
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start" data-scrollax-parent="true">
          <div class="col-md-9 ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
            ...
            <div class="block-17 my-4">
              <form action="room01.php" method="get" class="d-block d-flex">
						...
						<div class="form-group">
							<select type="text" name="city" class="form-control" placeholder="City">
								...
								foreach($result as $key => $row){
									...
									echo "<option value='$city_id'>$city_name, $countries_name</option>";
								}
								?>
							</select>
						</div>
