        ...
        <div class="">
          <div class="">
            <form action="#" method="post">
              ...
              <div class="form-group">
                <select type="text" name="countries" class="form-control" placeholder="Countries">
                <?php
              ...
              <div class="form-group">
                <input type="submit" name="addCity" value="submit" class="btn btn-primary form-control">
              </div>
